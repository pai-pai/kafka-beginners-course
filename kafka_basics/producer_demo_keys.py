"""Python's version of ProducerDemoKeys.java
...
logging.basicConfig(
    ...
    datefmt='%Y-%m-%d %H:%M:%S',
    filename='logs/producer_demo_keys.log',
    filemode='w',
)
...
def producer_demo_keys():
    def on_delivery(err, msg):
        ...
        if err is not None:
            ...
            message = f"Key: {msg.key().decode('utf-8')} | Partition: {msg.partition()}"
            logger.info(message)
